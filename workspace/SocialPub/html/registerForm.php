 <form id="registerForm">
    ...
    <div class="control-group">
        <label>Country</label>
            ...
            <option value = GY> Guyana (British)

            <option value = GF> Guyana (French)
            ...
            <option value = UG> Republic of Uganda

            <option value = RE> Reunion Islands

            <option value = RO> Romania

            <option value = RU> Russian Federation The
            ...
            <option value = XY> St Barthelem

            <option value = XE> St Eustatius
            ...
            <option value = TZ> United Republic of Tanzania
