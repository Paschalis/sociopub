...
$viewArticleSrt = "CALL view_article('".$articleID."','".$username."')";

$result = mysql_query($viewArticleSrt) or handleLikeArticleError(mysql_error());
 ...
 *
 * */
function printViewsData($resultCode, $row){
